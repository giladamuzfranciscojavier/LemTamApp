Pequeña aplicación desarrollada en junio de 2024 como favor personal para gestionar el vestuario de una asociación folklórica mediante una base de datos MySQL y el ORM Hibernate.
